...
public class ListDataSource {
    ...
    public void initialize()
    {
        ...
        branchList.add(new Branch(new Address("Hifa sanhedria 12a","israel",12,12),50,11,"@drawable/rental",15000,new MyDate(2,"july",2055),true));
        ...
        branchList.add(new Branch(new Address("Bet Shemesh Hatziporen 12a","israel",234,234),12,12,"@drawable/rental",15000,new MyDate(2,"july",2055),true));
        ...
        branchList.add(new Branch(new Address("Elat harambam 12a","israel",234,234),13,13,"@drawable/rental",15000,new MyDate(2,"july",2055),true));
        ...
        branchList.add(new Branch(new Address("Beer Sheva hacharutzim 12a","israel",12,12),14,14,"@drawable/rental",15000,new MyDate(2,"july",2055),true));
        ...
        branchList.add(new Branch(new Address("Hifa alenbyz 12a","israel",213,123),15,15,"@drawable/rental",15000,new MyDate(2,"july",2055),true));
        ...
        branchList.add(new Branch(new Address("Hifa alenbyf 12a","israel",324,324),16,16,"@drawable/rental",15000,new MyDate(2,"july",2055),true));
        clientList.add(new Client("lambde","melon",316,"999","s@e.com","111"));


        branchList.add(new Branch(new Address("Hadera sanhedria 15b","israel",324,234),40,22,"@drawable/rental",3000,new MyDate(24,"June",1999),false));
