...
public class ListDataSource {
    ...
    public void initialize()
    {
        ...
        carList.add(new Car(11,11,50,11,3.5,30,74,35,"@drawable/audi8",1997,false));
        branchList.add(new Branch(new Address("Hifa","sanhedria","12a"),12,11,"@drawable/rental",15000,new MyDate(2,"july",2055)));
        ...
        carList.add(new Car(12,12,50,11,4.5,45,20,45,"@drawable/car",1992,true));
        branchList.add(new Branch(new Address("Bet Shemesh","Hatziporen","12a"),12,12,"@drawable/rental",15000,new MyDate(2,"july",2055)));
        ...
        carList.add(new Car(13,13,50,11,1.5,48,10,62,"@drawable/car",2005,true));
        branchList.add(new Branch(new Address("Elat","harambam","12a"),13,13,"@drawable/rental",15000,new MyDate(2,"july",2055)));
        ...
        carList.add(new Car(14,14,50,11,3,5,70,70,"@drawable/car",1994,false));
        branchList.add(new Branch(new Address("Beer Sheva","hacharutzim","12a"),14,14,"@drawable/rental",15000,new MyDate(2,"july",2055)));
        ...
        carList.add(new Car(15,15,50,11,5,200,70,70,"@drawable/car",2994,true));
        branchList.add(new Branch(new Address("Hifa","alenbyz","12a"),15,15,"@drawable/rental",15000,new MyDate(2,"july",2055)));
        ...
        carList.add(new Car(16,16,50,11,2.5,33,70,70,"@drawable/car",1894,false));
        branchList.add(new Branch(new Address("Hifa","alenbyf","12a"),16,16,"@drawable/rental",15000,new MyDate(2,"july",2055)));
